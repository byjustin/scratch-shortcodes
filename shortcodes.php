...
Description: Shortcodes for themes generater by Scratch.
...
function scratch_sc_button( $atts , $content = null ) {
	...
	ob_start(); ?>
		...
		<a href="<?php echo esc_attr($link); ?>" class="button <?php echo esc_attr($size); ?> <?php echo esc_attr($type); ?> <?php echo esc_attr($style); ?>"><?php echo do_shortcode($content); ?></a>
...
function scratch_sc_tooltip( $atts , $content = null ) {
	...
	ob_start(); ?>
		...
		<span class="has-tip <?php echo esc_attr($position); ?> <?php echo esc_attr($type); ?> <?php echo esc_attr($tip); ?>" data-tooltip><?php echo do_shortcode($content); ?></span>
...
function scratch_sc_label( $atts , $content = null ) {
	...
	ob_start(); ?>
		...
		<span class="label <?php echo esc_attr($type); ?> <?php echo esc_attr($style); ?>"><?php echo do_shortcode($content); ?></span>
...
function scratch_sc_visibility( $atts , $content = null ) {
	...
	<span class="<?php
		...
		if ( !empty( $show ) ) {
			echo 'show-for-'. esc_attr( $show ) .''; } ?>"><?php echo do_shortcode($content); ?></span>
